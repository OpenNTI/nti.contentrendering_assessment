...
def _patch():
	...
	nutils.get_contenttype.func_globals['component'] = component
	nutils.get_contenttype.func_globals['IMimeTypeGetter'] = IMimeTypeGetter
	nutils.get_contenttype.func_globals['nameFinder'] = nameFinder
