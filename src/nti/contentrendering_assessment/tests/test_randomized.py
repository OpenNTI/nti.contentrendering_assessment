...
class TestRandomized(AssessmentRenderingTestCase):
    ...
    def test_randomizedquestionset_macros(self):
        ...
        assert_that(dom.getElementsByTagName('narandomizedquestionset'), 
                    has_length(1))
        assert_that(dom.getElementsByTagName('narandomizedquestionset')[0], 
                    is_(narandomizedquestionset))

        qsets = dom.getElementsByTagName('narandomizedquestionset')
        qset_object = qsets[0].assessment_object()
